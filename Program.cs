...
/*
Reference:
https://docs.microsoft.com/en-us/graph/tutorials/dotnet-core?view=graph-rest-beta
*/
namespace GraphTutorial
{
    class Program
    {
        ...
        static void ListInboxMessages()
        {
            var inbox = GraphHelper.GetInboxMessage().Result;

            Console.WriteLine("Messgaes:");

            foreach (var message in inbox)
            {
                Console.WriteLine($"  Subject: {message.Subject}");
                Console.WriteLine($"  From: {message.From.EmailAddress}");
                Console.WriteLine($"  BodyPreview: {message.BodyPreview}");
            }
        }
